...
| 回忆记录 | 标题、日期、正文、图片/视频；各自上传各自可见 |
| 未来愿望 | 可多条添加 / 编辑 / 删除；含「写给讲台」模板 |
...
| 模块 | 说明 |
|------|------|
| 阶段背景 / 图标 | 按阶段上传自定义背景与图标 |
| 浏览 BGM | 独立于登录开场；右下角开关与音量（记忆本地） |
| 回忆筛选 | 按关键词、年份筛选当前阶段回忆 |
| 我的 | 账号安全、信件、寄语、阶段与 BGM、开场、背景等 |
